...
void ACarlaEditorPlayerController::SetupInputComponent()
{
    ...
    UPlayerInput::AddEngineDefinedActionMapping(FInputActionKeyMapping("LeftMouseClick", EKeys::LeftMouseButton));
    UPlayerInput::AddEngineDefinedActionMapping(FInputActionKeyMapping("RightMouseClick", EKeys::RightMouseButton));
    ...
    InputComponent->BindAction("LeftMouseClick", IE_Pressed, this, &ACarlaEditorPlayerController::ConsumeLeftMouseButtonPressed);
    InputComponent->BindAction("LeftMouseClick", IE_Released, this, &ACarlaEditorPlayerController::ConsumeLeftMouseButtonReleased);
    InputComponent->BindAction("RightMouseClick", IE_DoubleClick, this, &ACarlaEditorPlayerController::ConsumeRightMouseButtonDoubleClick);
