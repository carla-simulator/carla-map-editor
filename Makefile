...
UNREALROOTPATH = /home/aclear/UnrealEngine_4.21
GAMEPROJECTFILE =/home/aclear/carla/Unreal/CarlaEditor/CarlaEditor.uproject

TARGETS = \
	CarlaEditor-Linux-Debug  \
	CarlaEditor-Linux-DebugGame  \
	CarlaEditor-Linux-Shipping  \
	CarlaEditor-Linux-Test  \
	CarlaEditor \
	CarlaEditorEditor-Linux-Debug  \
	CarlaEditorEditor-Linux-DebugGame  \
	CarlaEditorEditor-Linux-Shipping  \
	CarlaEditorEditor-Linux-Test  \
	CarlaEditorEditor \
...
CarlaEditor-Linux-Debug:
	 $(PROJECTBUILD) CarlaEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CarlaEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditor-Linux-Shipping:
	 $(PROJECTBUILD) CarlaEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditor-Linux-Test:
	 $(PROJECTBUILD) CarlaEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditor:
	 $(PROJECTBUILD) CarlaEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditorEditor-Linux-Debug:
	 $(PROJECTBUILD) CarlaEditorEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditorEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CarlaEditorEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditorEditor-Linux-Shipping:
	 $(PROJECTBUILD) CarlaEditorEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditorEditor-Linux-Test:
	 $(PROJECTBUILD) CarlaEditorEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CarlaEditorEditor:
	 $(PROJECTBUILD) CarlaEditorEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
